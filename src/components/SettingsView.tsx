...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div
      className="px-5 pt-5 space-y-4 overflow-scroll w-full h-full overflow-x-hidden scrollbar-thin scrollbar-track-rixa-dark 
    ...
    >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-rixa-cream/60">
      ...
      <div className="bg-rixa-dark rounded-lg p-6 border border-rixa-red/40">
        <h3 className="text-lg font-semibold text-rixa-red mb-4">
          Danger Zone
        </h3>
